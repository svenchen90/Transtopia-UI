...
<html>
    ...
    <body class="hold-transition sidebar-mini skin-red-light" id="post_main_page" type="user" userid="<%=user.my_groupid%>">
        <div class="wrapper">
...
<!--                            <i class="fa fa-chevron-circle-right" aria-hidden="true"></i><a class="hand_pointer"  href="index.jsp" style="margin-left:10px; color:white"><b>动态</b></a>-->
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="#" id="top_nav_name" class="top_nav_name" style="font-size:18px; font-weight:bold">个人</a></li>
                        </ul>
                        <form class="navbar-form navbar-left" role="search" style="margin-left:15px;">
                            <div class="input-group">
                                <input type="text" name="q" class="form-control" placeholder="Search..." id="navbar-search-input" style="width:600px;">
            ...
            <aside class="main-sidebar" id="sideBar_Transtopia" style="background-color: #ecf0f5;padding-top:50px;">
                <ul class="sidebar-menu" style="margin-top:20px;">
                    ...
                    <li class="sider_nav_list" data-filter="groups" data-name="社群"><a href="javascript:void(0);" class="post_nav_tab" ><i class="fa fa-fire" aria-hidden="true"></i><span>社群</span></a></li>                    
                    ...
                    <li class="sider_nav_list active" data-filter="mineInfo" data-name="个人"><a href="javascript:void(0);" class="post_nav_tab" ><i class="fa fa-user-o" aria-hidden="true"></i><span>个人</span></a></li>
                </ul>
                </section>
            </aside>
            ...
            <div class="content-wrapper" style="border-left:none;">
                <section class="content row" id="content_Transtopia">
                    ...
                    <div class="post_content col-md-12">
                        ...
                        <div  class="post_content_page container-fluid col-md-12">
                            <!-- 用户信息 -->
                            <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-image" style="top:75px;">
                                    <img data-type="img" class="img-circle" style="height:60px;width:60px;" >
                                </div>
                                <div class="box-footer user-box-footer" style="padding-top:15px;padding-bottom:0px;">

                                    <div class="col-md-12">
                                        <div class="col-sm-12" style="text-align: center">
                                            <strong data-type="name" style="font-size: 20px;"></strong>
                                            <strong style="margin-left: 10px; position: relative;top:-4px;" class="infoList">
                                            </strong></br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 user-category">
                                    ...
                                    <div class='col-md-3 userType' style='margin-top:20px;margin-bottom: 10px;'>
                                    </div>
    
                                    <div class='col-md-3 userType' style='margin-top:20px;margin-bottom: 10px;'>
                                        <a class="btn btn-block btn-social btn-dropbox post_tab" data-type="following_post">
                                            <i class="fa  fa-podcast"></i> <span>我的动态</span> <span data-type="moment-count" class="badge" style='float:right'> 4</span>
                                        </a>
                                    </div>
                                    
                                    <div class='col-md-3 userType' style='margin-top:20px;margin-bottom: 10px;'>
                                        <a class="btn btn-block btn-social btn-google post_tab" data-type="collection_posts">
                                            <i class="fa  fa-podcast"></i> <span>我的收藏</span> <span data-type="collection-count" class="badge" style='float:right'> 4</span>
                                        </a>
                                    </div>
...
<!--                                    <div class='col-md-2 userType' style='margin-top:20px; margin-bottom: 10px;'>
                                    ...
                                    <div class='col-md-2 userType' style='margin-top:20px; margin-bottom: 10px;'>
                                        <a class="btn btn-block btn-social btn-facebook post_tab" data-type="following_users">
                                            <i class="fa  fa-user"></i> <span data-type="following_users_name" >我关注的人</span> <span data-type="following_users_count" class="badge" style='float:right'>4</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class='col-md-2 userType' style='margin-top:20px; margin-bottom: 10px;'>
                                        <a class="btn btn-block btn-social btn-tumblr btn-github post_tab" data-type="following_groups">
                            ...
                            <div class="box box-widget" style="box-shadow: none;background:transparent;">
                                <div class="container-fluid" id="post_info_content" style="background:transparent; padding-left:0px; padding-right:0px;column-count: 4">

                                </div>
                                <div class="container-fluid" id="post_info_content_1" style="background:transparent; padding-left:0px; padding-right:0px; display: none;">
