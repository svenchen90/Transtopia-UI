...
<html>
    ...
    <body class="hold-transition sidebar-mini skin-red-light" id="post_main_page" type="search_info" qname="<%=qname%>" soption="<%=soption%>" userid="<%=user.my_groupid%>">
        <div class="wrapper">
...
<!--                            <i class="fa fa-chevron-circle-right" aria-hidden="true"></i><a class="hand_pointer"  href="index.jsp" style="margin-left:10px; color:white"><b>动态</b></a>-->
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="#" id="top_nav_name" class="top_nav_name" style="font-size:18px; font-weight:bold"><%=qname%></a></li>
                        </ul>
            ...
            <div class="content-wrapper" style="border-left:none;">
                <section class="content row" id="content_Transtopia">
                    ...
                    <div class="post_content col-md-12">
                        <div class="container-fluid post_content_page_group" style="padding-right:0px; padding-left:0px; margin-top:20px;margin-bottom: 20px;">
                            <a style="float:left;" class="post_search_bar">社群</a><a style="float:right;margin-right:10%;" class="post_search_bar">展开</a>
                        </div>
                        <div class="container-fluid post_content_page_group post_content_page_group_main" style="padding-right:0px; padding-left:0px;text-align: center;">
                        </div>

                        <div class="container-fluid post_content_page_user" style="padding-right:0px; padding-left:0px; margin-top:20px;margin-bottom: 20px;">
                            <a style="float:left;" class="post_search_bar">用户</a><a style="float:right;margin-right:10%;" class="post_search_bar">展开</a>
                        </div>
                        <div class="container-fluid post_content_page_user post_content_page_user_main" style="padding-right:0px; padding-left:0px; text-align: center;">
                        </div>

                        <div class="container-fluid post_content_page_post" style="padding-right:0px; padding-left:0px; margin-top:20px;margin-bottom: 20px;">
                            <a style="float:left;" class="post_search_bar">动态</a><a style="float:right;margin-right:10%;" class="post_search_bar">展开</a>
                        </div>
                        <div class="container-fluid post_content_page_post post_content_page_post_main col-md-12" style="padding-right:0px; padding-left:0px; column-count: 4">
                        </div>
