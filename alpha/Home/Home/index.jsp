...
<html>
    ...
    <body class="hold-transition sidebar-mini skin-red-light" id="post_main_page" type="home" style="min-width:1400px;" userid="<%=mygid%>" uimage="<%=user.image%>">
        <div class="wrapper">
...
<!--                            <i class="fa fa-chevron-circle-right" aria-hidden="true"></i><a class="hand_pointer"  href="index.jsp" style="margin-left:10px; color:white"><b>动态</b></a>-->
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="#" id="top_nav_name" class="top_nav_name" style="font-size:18px; font-weight:bold" >发现</a></li>
                        </ul>
                ...
                <nav class="navbar navbar-static-top nav_post_top_bar" style="margin-left:0px; display: block; z-index:500;" id="nav_recommend_tab" status="0">
                    ...
                    <div class="container-fluid" style="text-align: center;">
                        <ul class="nav navbar-nav" style="float:none;display: inline-block;">
                            <li class="active page_top_nav_list page_top_nav_list_1" style="margin-right:10px;" data-filter="all_posts"><a href="javascript:void(0);">全部</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="hot_posts"><a href="javascript:void(0);">热门</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="friend_posts"><a href="javascript:void(0);" >朋友</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="group_posts"><a href="javascript:void(0);" >社群</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="product_posts"><a href="javascript:void(0);">商品</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="collection_posts"><a href="javascript:void(0);" >收藏</a></li>
                        </ul>
                    </div>
            ...
            <aside class="main-sidebar" id="sideBar_Transtopia" style="background-color: #ecf0f5;padding-top:100px;">
                <ul class="sidebar-menu" style="margin-top:20px;">
                    ...
                    <li class="sider_nav_list active" data-filter="all_posts" data-name="发现"><a href="javascript:void(0);" class="post_nav_tab" ><i class="fa fa-list-ol" aria-hidden="true"></i><span>发现</span></a></li>
