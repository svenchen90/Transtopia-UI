...
<html>
    ...
    <body class="hold-transition sidebar-mini skin-red-light" id="post_main_page" type="friends" userid="<%=user.my_groupid%>">
        <div class="wrapper">
                ...
                <nav class="navbar navbar-static-top" style="margin-left:0px;">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="#" id="top_nav_name" class="top_nav_name" style="font-size:18px; font-weight:bold">人脉</a></li>
                        </ul>
                ...
                <nav class="navbar navbar-static-top nav_post_top_bar" style="margin-left:0px; display: block; z-index:500;" id="nav_recommend_tab" status="0">
                    ...
                    <div class="container-fluid" style="text-align: center;">
                        <ul class="nav navbar-nav" style="float:none;display: inline-block;">
                            <li class="active page_top_nav_list page_top_nav_list_1" style="margin-right:10px;" data-filter="hot_user_items"><a href="javascript:void(0);">推荐</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="following_user_items"><a href="javascript:void(0);">我的关注</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="followed_user_items"><a href="javascript:void(0);">关注我的</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="in_user_items"><a href="javascript:void(0);" >我的好友</a></li>
                            <li class="page_top_nav_list" style="margin-right:10px;" data-filter="request_user_items"><a href="javascript:void(0);" >好友申请</a></li>
                        </ul>
                    </div>
            ...
            <aside class="main-sidebar" id="sideBar_Transtopia" style="background-color: #ecf0f5;padding-top:100px;">
                <ul class="sidebar-menu" style="margin-top:20px;">
                    ...
                    <li class="sider_nav_list active" data-filter="friends" data-name="人脉"><a href="javascript:void(0);" class="post_nav_tab" ><i class="fa fa-star" aria-hidden="true"></i><span>人脉</span></a></li>
            ...
            <div class="content-wrapper" style="border-left:none;">
                <section class="content row" id="content_Transtopia">
                    ...
                    <div class="post_content col-md-12">
                        ...
                        <!-- /.Choose Friend List -->
                        <div class="modal fade" id="modal_friend_option">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">选择邀请方式</h4>
                                    </div>
                                    <div class="modal-body row">
                                        <div class="col-md-12">
                                            <div class="friend-list-item col-sm-4" value="0" style="text-align: center;">
                                            ...
                                            <div class="friend-list-item col-sm-4"  value="1" style="text-align: center;">
                                            ...
                                            <div class="friend-list-item col-sm-4"  value="2" style="text-align: center;">
                                        ...
                                        <div class="col-md-12">
                                            <div class="friend-list-item col-sm-4"  value="3" style="text-align: center;">
                                            ...
                                            <div class="friend-list-item col-sm-4"  value="4" style="text-align: center;">
                                            ...
                                            <div class="friend-list-item col-sm-4"  value="5" style="text-align: center;">
                        ...
                        <!-- /.sendFriendRequest -->
                        <div class="modal fade" id="modal_addfriend_email">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">电子邮箱邀请</h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>邮箱: </label>
                                            <select id="adding_friend_email" class="form-control" data-placeholder="请输入成员邮箱" style="width: 100%;">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                        <button type="button" class="btn btn-primary submit doSendingFriendRequest">确认</button>
                                    </div>
                                </div>
                            </div>
                        </div>
