...
<html>
    <head>
        ...
        <style>
            ...
            .un_task_list.ui-draggable-dragging
            {
                z-index: 2000;
            }
    ...
    <body id="project_body" userid='<%=userid%>' name="<%=name%>" pid="<%=pid%>" basicInfo='<%=basicInfo%>' task_models_info='<%=task_models_info%>' st_id='<%=st_id%>' ppath="<%=ppPath%>" parentID="<%=parentID%>" path="<%=path%>"  userInfo='<%=userInfo%>'>
                ...
                <div class="collapse navbar-collapse" id="myNavbar" number="8">
                    <ul class="nav navbar-nav">
                        <li id="0_nav">
                            <%
                                if (name.equals("")) {%>
                            <a id="stask_name" class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" style="color:white" onclick="showNav_Option(0)">项目名称<span class="caret"></span></a>
                                <%} else {%>
                            <a id="stask_name" class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);" style="color:white" onclick="showNav_Option(0)"><%=name%><span class="caret"></span></a>
                                <%}
                                %>
                        ...
                        <li id="8_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(8)">项目动态</a></li>
                        <li id="1_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(1)">基本信息</a></li>
                        <li id="2_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(2)">调查内容</a></li>
                        <li id="3_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(3)">人员分配</a></li>
                        <li id="4_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(4)">汇总校核</a></li>
                        <li id="5_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(5)">项目成果</a></li>
                        <li id="6_nav"><a href="javascript:void(0)" style="color:white" onclick="showNav_Option(6)">帮助与支持</a></li>
        ...
        <div class="intersection_Section" id="intersection_section" flag="false" style="display:block;">
            <div style="width:400px;height: 40px;margin-top: 10px;">
                <div class="intersection_title intersection_title_active" style="float:left;margin-left: 25px;" id="inter_option_1" onclick="show_intersection_option(1)">
                    <label class="survey_a" >交叉口渠化</label></div>
                <div class="intersection_title" id="inter_option_2" onclick="show_intersection_option(2);"> <label  class="survey_a">流量调查任务</label></div>
            </div>
            <div class="in_section_1" style="display:block;" id="intersection_quhua" flag="false">                
                <div class="demo lock nav_body nav_layout">
                    <div class="left_nav" style="width:500px;height:320px;">
                        ...
                        <div id="tb-map" style="width:450px;height:350px;">

                        </div>

                        <div id="intersection_canvas">
                            <canvas id="inter_template" style="width:450px;height:350px;"></canvas>
                        </div>

                    </div>
                    <div id="model_date" class="model_date">
                        <span style="font-size:20px;color:red;position: relative;top:3px;">调查开始的日期:</span><input style="font-size:20px;color:red;" class="laydate-icon" name="t_model_date" id="t_model_date" >
                    </div>
                    <div class="sideBySide nav_side">
                        <div class="tool_bar">
                            <div>
                                <span>社会车辆</span>
                            <ul class="nav nav-pills sourcejQ_inter" style="width:450px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="border:none; text-align: left" colspan="4">
                                    <button type="button" class="btn btn-success" id="task_create_intersection" onclick="taskinfoSave()">保存任务</button>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
//                        $("#task_cars_light").draggable();
        ...
        <div class="intersection_Section" id="task_ass_section" flag="false" style="display:none;">
            <div class="all_task" style="display: block;" id="seg_task" flag="false">                
                <div class="nav_task task_align" style="margin-top: 5px;border:1px solid white;height: 650px;width:400px;"> 
                    <div class="ass_task_nav" style="margin-left: 5px;">
                        <a href="javascript:void(0);" onclick="showRemainTasks();"><label id="unTasks" style="font-size: 18px;margin-top:5px;margin-bottom: 5px;">未分配任务:<span id="un_task_number">0/span>个</label></a>
                        <div style="margin-left:10px;margin-top:10px;">日期:&nbsp;&nbsp;<input class="laydate-icon" id="task_date" name="from" style="width:150px;">

                        </div>
                    </div>
                    <ul class="list-group sourcejQ_assign" id="un_task_assign" number="0" style="width:360px;margin-top: 10px;height:550px;overflow-y: scroll" currentID="0">
                    </ul>
                ...
                <div class="p_task_ass"  style="width: 550px;height: 650px;position: absolute;display: inline-block;margin-top: 5px;margin-left: -10px;"> 
                    <div style="border:1px solid white;">
                        ...
                        <div style="margin-left:10px;height:30px;">
                            ...
                            <img src="./img/p_add.png" class="p_status" style="position: relative; top: -30px;right: -440px;" onclick="addNewPerson()">
                        </div>
                        <div style="margin-top:20px;height: 265px;overflow-y: scroll" id="persons_task" currentID="0" number="<%=usize%>">
                ...
                <div style="text-align:left; margin:5px; position:absolute;top: 550px;left: 1005px;" class="con_buttons">
        ...
        <div class="tiva-events-calendar full intersection_Section" data-source="ajax" id="task_view_section" style="display: none; width:1200px;overflow-y: scroll"></div>
