<%-- 
    Document   : index
    Created on : Jan 6, 2017, 10:21:42 AM
    Author     : zhichengfu
--%>
  ...
  <body>
    <nav id="topNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#first"><i class="fa fa-home" aria-hidden="true"></i>Transtopia</a>
            </div>
            <div class="navbar-collapse collapse" id="bs-navbar">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="page-scroll" href="#one">关于我们</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#two">产品</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#three">服务</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#four">价格</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#last">联系我们</a>
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" data-toggle="modal" title="A free Bootstrap video landing theme" href="javascript:void(0)" onclick="showLogIn()">登录</a>
                    </li>
                     <li>
                        <a class="page-scroll" data-toggle="modal" title="A free Bootstrap video landing theme" href="javascript:void(0)" onclick="showCodeImage();">注册</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header id="first">
        <div class="header-content">
            <div class="inner">
                <h1 class="cursive">实现城市智慧交通</h1>
                <h4>智慧交通的设计和协作平台</h4>
                <hr>
               <a href="#one" class="btn btn-primary btn-xl page-scroll">开始探索</a>
            </div>
        </div>
    ...
    <script src="./JS/home_mine.js"></script>
  </body>
</html>