...
(
	function($){
		...
		/* 11. 创建修改群组信息模态框 */
		$.fn.createEditGroupModal = function(data){	
			var html = $(
				...
				'						<input class="form-control input-lg" value="' + data.name + '"' + (data.authority==1 ? '' : 'disabled') + ' />\n' +
				'					</div>\n' +
				'					<div class="form-group">\n' +
				'						<p><i class="fa fa-pencil-square"></i> 群组简介</p>\n' +
				'						<input class="form-control input-lg" value="' + data.description + '"' + (data.authority==1 ? '' : 'disabled') + ' />\n' +
				'					</div>\n' +
				'					<div class="form-group">\n' +
				'						<p><i class="fa fa-pencil"></i> 兴趣类别 <span class="pull-right"><a href="#" data-action="editGenres" class="' + (data.authority==1 ? '' : 'hide') + '">修改</a></span></p>\n' +
				'						<div style="margin-top:10px;">\n' +
				'						</div>\n' +
				'					</div>\n' +
				'					<div class="form-group">\n' +
				'						<p><i class="fa fa-tags"></i> 兴趣话题 <span class="pull-right"><a href="#" data-action="editTopic" class="' + (data.authority==1 ? '' : 'hide') + '">修改</a></span></p>\n' +
				'						<div style="margin-top:10px;">\n' +		
				'						</div>\n' +
				'					</div>\n' +	
				'					<div class="form-group">\n' +
				'						<p><i class="fa fa-qrcode"></i> 二维码</p>\n' +
				'						<div style="text-align: center;"><img src="http://www.liantu.com/images/2013/liantu.png" style="height: 200px;"/></div>\n' +
				'					</div>\n' +
				'				</div>\n' +
				'			</div>\n' +
				'		</div>\n' +
			...
			//加载群组类别
			$.each(data.genre, function(i, g){
				$(html).find('.main-content > .form-group:eq(2) div').append('<span class="label" style="margin-right: 5px; background-color: ' + googleColorRandomPicker() + ';">' + g + '</span>');
			});
			//加载群组兴趣
			$.each(data.topic, function(i, t){
				$(html).find('.main-content > .form-group:eq(3) div').append('<span class="label" style="margin-right: 5px; background-color: ' + googleColorRandomPicker() + ';">' + t + '</span>');
			});
